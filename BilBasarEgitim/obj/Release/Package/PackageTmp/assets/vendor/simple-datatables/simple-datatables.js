                    ...
                    (function(global) {
                        (function() {
                            ...
                            const t = t => "[object Object]" === Object.prototype.toString.call(t),
                                ...
                                i = t => ["#text", "#comment"].includes(t.nodeName)
                                    ? t.data
                                    : t.childNodes
                            ...
                            function r(t, e, s) {
                                ...
                                return"#text" === t.nodeName
                                    ...
                                    : (e
                                            ...
                                            ? (i = s.document.createElementNS("http://www.w3.org/2000/svg", "svg"), e =
                                                !0)
                                            : i = s.document.createElement(t.nodeName), t.attributes &&
                                            Object.entries(t.attributes).forEach((function(t) {
                                                var e = t[0], s = t[1];
                                                return i.setAttribute(e, s)
                                            })), t.childNodes &&
                                            t.childNodes.forEach((function(t) { return i.appendChild(r(t, e, s)) })),
                                        s.valueDiffing &&
                                        (t.value &&
                                            ...
                                            (i.value = t.value), t.checked &&
                                            i instanceof HTMLInputElement &&
                                            (i.checked = t.checked), t.selected &&
                                            i instanceof HTMLOptionElement &&
                                            (i.selected = t.selected))), i
                            }
                            ...
                            function d(t, e, s) {
                                ...
                                case s._const.modifyAttribute:
                                    if (!(i && i instanceof Element)) return!1;
                                    i.setAttribute(e[s._const.name], e[s._const.newValue]), i instanceof
                                        HTMLInputElement &&
                                ...
                                case s._const.replaceElement:
                                    i.parentNode.replaceChild(r(e[s._const.newValue],
                                ...
                                case s._const.relocateGroup:
                                    Array.apply(void 0, new Array(e[s._const.groupLength]))
                                        .map((function() { return i.removeChild(i.childNodes[e[s._const.from]]) }))
                                ...
                                case s._const.addElement:
                                    ...
                                    i.insertBefore(r(e[s._const.element],
                                ...
                                case s._const.addTextElement:
                                    var u;
                                    if (h = (u = d.slice()).splice(u.length - 1, 1)[0], n =
                                        s.document.createTextNode(e[s._const.value]), !(i = l(t, u)).childNodes)
                                        return!1;
                            ...
                            var h = function(t) {
                                    var e = [];
                                    return e.push(t.nodeName), "#text" !== t.nodeName &&
                                        "#comment" !== t.nodeName &&
                                        t.attributes &&
                                        (t.attributes.class &&
                                            e.push("".concat(t.nodeName, ".")
                                                .concat(t.attributes.class.replace(/ /g, "."))), t.attributes.id &&
                                            e.push("".concat(t.nodeName, "#").concat(t.attributes.id))), e
                                },
                                u = function(t) {
                                    var e = {}, s = {};
                                ...
                                p = function(t, e) {
                                    var s = u(t), i = u(e), n = {};
                                    return Object.keys(s).forEach((function(t) { i[t] && (n[t] = !0) })), n
                                },
                                f = function(t) {
                                    return delete t.outerDone, delete t.innerDone, delete t.valueDone, !t.childNodes ||
                                        t.childNodes.every(f)
                                },
                                m = function(t) {
                                    if (Object.prototype.hasOwnProperty.call(t, "data"))
                                        return{ nodeName: "#text" === t.nodeName ? "#text" : "#comment", data: t.data };
                                    var e = { nodeName: t.nodeName };
                                    return Object.prototype.hasOwnProperty.call(t, "attributes") &&
                                        ...
                                        Object.prototype.hasOwnProperty.call(t, "childNodes") &&
                                            (e.childNodes = t.childNodes.map((function(t) { return m(t) }))), e
                                },
                                g = function(t, e) {
                                ...
                                b = function(t, e, s, i, n) {
                                    ...
                                    if (t.attributes && e.attributes) {
                                        ...
                                        if (t.attributes.class &&
                                            t.attributes.class === e.attributes.class &&
                                            "".concat(t.nodeName, ".").concat(t.attributes.class.replace(/ /g, ".")) in
                                            s)
                                            return!0
                                    }
                                    if (i) return!0;
                                    ...
                                    if (n) return a.every((function(t, e) { return t.nodeName === o[e].nodeName }));
                                    var r = p(a, o);
                                    return a.every((function(t, e) { return b(t, o[e], r, !0, !0) }))
                                },
                                v = function(t, e) {
                                    return Array.apply(void 0, new Array(t)).map((function() { return e }))
                                },
                                _ = function(t, e) {
                                    for (var s = t.childNodes ? t.childNodes : [],
                                        i = e.childNodes ? e.childNodes : [],
                                        n = v(s.length, !1),
                                        a = v(i.length, !1),
                                        o = [],
                                        r = function() { return arguments[1] },
                                        l = !1,
                                        d = function() {
                                                ...
                                                for (var u = 0; u < o; u++)
                                                    for (var f = t[u], m = 0; m < r; m++) {
                                                        ...
                                                        s[u] || i[m] || !b(f, g, d, c)
                                                            ? l[u + 1][m + 1] = 0
                                                            : (l[u + 1][m + 1] =
                                                                l[u][m] ? l[u][m] + 1 : 1, l[u + 1][m + 1] >= n &&
                                                                (n = l[u + 1][m + 1], a = [u + 1, m + 1]))
                                                    }
                                                return 0 !== n && { oldValue: a[0] - n, newValue: a[1] - n, length: n }
                                            }(s, i, n, a);
                                            t
                                                ? (o.push(t), Array.apply(void 0, new Array(t.length)).map(r).forEach(
                                                    (function(e) {
                                ...
                                w = function() {
                                    function t() { this.list = [] }

                                    return t.prototype.add = function(t) {
                                        var e;
                                        (e = this.list).push.apply(e, t)
                                    }, t.prototype.forEach = function(t) {
                                        this.list.forEach((function(e) { return t(e) }))
                                    }, t
                                }(),
                                y = function() {
                                    function t(t) {
                                    ...
                                    return t.prototype.toString =
                                        function() { return JSON.stringify(this) }, t.prototype.setValue =
                                        function(t, e) {
                            ...
                            function N(t, e, s) {
                                return e.forEach((function(e) {
                                    !function(t, e, s) {
                                        var i, n, a, o;
                                        if (![s._const.addElement, s._const.addTextElement]
                                        ...
                                        case s._const.addAttribute:
                                            n.attributes || (n.attributes = {}), n.attributes[e[s._const.name]] =
                                                e[s._const.value], "checked" === e[s._const.name]
                                                ? n.checked = !0
                                        ...
                                        case s._const.replaceElement:
                                            ...
                                            break;
                                        case s._const.relocateGroup:
                                            n.childNodes.splice(e[s._const.from], e[s._const.groupLength]).reverse()
                                                .forEach((function(t) {
                                                    return n.childNodes.splice(e[s._const.to], 0, t)
                                                })), n.subsets &&
                                                n.subsets.forEach((function(t) {
                                                    if (e[s._const.from] < e[s._const.to] &&
                                                    ...
                                                    else if (e[s._const.from] > e[s._const.to] &&
                                                        t.oldValue > e[s._const.to] &&
                                                        t.oldValue < e[s._const.from]) {
                                                        var i;
                                                        t.oldValue += e[s._const.groupLength],
                                            ...
                                            break;
                                        case s._const.removeElement:
                                            a.childNodes.splice(o, 1), a.subsets &&
                                        ...
                                        case s._const.addElement:
                                            ...
                                            n = null === (i = x(t, d)) || void 0 === i ? void 0 : i.node, l =
                                                    e[s._const.element], n.childNodes || (n.childNodes = []),
                                            ...
                                            break;
                                        case s._const.removeTextElement:
                                            a.childNodes.splice(o, 1), "TEXTAREA" === a.nodeName && delete a.value,
                                                a.subsets &&
                                                    a.subsets.forEach((function(t) {
                                                        t.oldValue > o
                                                            ? t.oldValue -= 1
                                        ...
                                        case s._const.addTextElement:
                                            ...
                                            (l = {}).nodeName = "#text", l.data =
                                                    e[s._const.value], (n = x(t, d).node).childNodes ||
                                                    (n.childNodes = []),
                                                ...
                                                n.subsets &&
                                                    n.subsets.forEach((function(t) {
                                                        if (t.oldValue >= p && (t.oldValue += 1), t.oldValue < p &&
                            ...
                            function D(t, e) {
                                ...
                                return t instanceof Text || t instanceof Comment
                                        ? s.data = t.data
                                        : (t.attributes &&
                                            t.attributes.length > 0 &&
                                            (s.attributes = {}, Array.prototype.slice.call(t.attributes).forEach(
                                                (function(t) {
                                            ...
                                            (s.childNodes = [], Array.prototype.slice.call(t.childNodes).forEach(
                                                (function(t) {
                                        ...
                                        (t instanceof HTMLInputElement &&
                                            ...
                                            (s.value = t.value), t instanceof HTMLOptionElement &&
                            ...
                            var $ = {
                                ...
                                C = function(t) {
                                    ...
                                    if (i &&
                                    (e.nodeName =
                                        i[1].toUpperCase(), ($[i[1]] || "/" === t.charAt(t.length - 2)) && (s = !0), e
                                        .nodeName
                                        .startsWith("!--"))) {
                                        var n = t.indexOf("--\x3e");
                                        return{
                                    ...
                                    for (var a = new RegExp(O), o = null, r = !1; !r;)
                                        if (null === (o = a.exec(t))) r = !0;
                                            ...
                                            if (o[1]) {
                                                var l = o[1].trim(), d = [l, ""];
                                                l.indexOf("=") > -1 && (d = l.split("=")), e.attributes[d[0]] =
                                                    d[1], a.lastIndex--
                                            } else
                                                o[2] &&
                                                    (e.attributes[o[2]] = o[3].trim().substring(1, o[3].length - 1));
                                    ...
                                    return t.replace(M,
                                        (function(r, l) {
                                            ...
                                            if (c) {
                                                ...
                                                return f &&
                                                        p.nodeName &&
                                                        (f.node.childNodes || (f.node.childNodes = []), f.node
                                                            .childNodes.push(p)),
                                                    ""
                                            }
                                            if (d) {
                                                s = C(r), n++,
                                                    "tag" === s.type &&
                                                        ...
                                                        (s.type = "component", o = !0), s.voidElement ||
                                                        o ||
                                                        !u ||
                                                        "<" === u ||
                                                        (s.node.childNodes || (s.node.childNodes = []), s.node
                                                            .childNodes.push({
                                                                nodeName: "#text",
                                                ...
                                                m &&
                                                    s.node.nodeName &&
                                                    (m.node.childNodes || (m.node.childNodes = []), m.node.childNodes
                                                        .push(
                                                            s.node)), a[n] = s
                                            }
                                            if ((!d || s.voidElement) &&
                                ...
                                S = function() {
                                    function t(t, e, s) {
                                        this.options = s, this.t1 =
                                            "undefined" != typeof Element && t instanceof Element
                                            ? D(t, this.options)
                                            : "string" == typeof t
                                            ? L(t, this.options)
                                            : JSON.parse(JSON.stringify(t)), this.t2 =
                                            "undefined" != typeof Element && e instanceof Element
                                            ? D(e, this.options)
                                            : "string" == typeof e
                                            ? L(e, this.options)
                                            : JSON.parse(JSON.stringify(e)), this.diffcount = 0, this.foundAll =
                                            !1, this.debug &&
                                        (this.t1Orig =
                                            "undefined" != typeof Element && t instanceof Element
                                            ? D(t, this.options)
                                            : "string" == typeof t
                                            ? L(t, this.options)
                                            : JSON.parse(JSON.stringify(t)), this.t2Orig =
                                            "undefined" != typeof Element && e instanceof Element
                                            ? D(e, this.options)
                                            : "string" == typeof e
                                            ? L(e, this.options)
                                            : JSON.parse(JSON.stringify(e))), this.tracker = new w
                                    }

                                    return t.prototype.init =
                                        function() { return this.findDiffs(this.t1, this.t2) }, t.prototype.findDiffs =
                                        function(t, e) {
                                            var s;
                                            do {
                                                ...
                                                0 === (s = this.findNextDiff(t, e, [])).length &&
                                                    ...
                                                    (this.foundAll
                                                        ...
                                                        : (this.foundAll = !0, f(t), s = this.findNextDiff(t, e, [])))),
                                                    s.length > 0 &&
                                                        (this.foundAll = !1, this.tracker.add(s), N(t, s, this.options))
                                            } while (s.length > 0);
                                        ...
                                        if (!t.outerDone) {
                                            if (i = this.findOuterDiff(t, e, s), this.options.filterOuterDiff &&
                                                (n = this.options.filterOuterDiff(t, e, i)) &&
                                                (i = n), i.length > 0) return t.outerDone = !0, i;
                                            t.outerDone = !0
                                        }
                                        ...
                                        if (t.nodeName !== e.nodeName) {
                                            ...
                                            return[
                                                (new y).setValue(this.options._const.action,
                                        ...
                                        if (Object.prototype.hasOwnProperty.call(t, "data") && t.data !== e.data)
                                            return"#text" === t.nodeName
                                                ? [
                                                    (new y)
                                                    .setValue(this.options._const.action,
                                        ...
                                        for (n = t.attributes ? Object.keys(t.attributes).sort() : [], a =
                                                e.attributes ? Object.keys(e.attributes).sort() : [], o = n.length, l =
                                                0;
                                            l < o;
                                            l++)
                                            i = n[l], -1 === (r = a.indexOf(i))
                                                ? d.push((new y)
                                                    .setValue(this.options._const.action,
                                                ...
                                                : (a.splice(r, 1), t.attributes[i] !== e.attributes[i] &&
                                                    d.push((new y)
                                                        .setValue(this.options._const.action,
                                        ...
                                        if (!this.options.maxChildCount || a < this.options.maxChildCount) {
                                            ...
                                            if (c.length > 0 &&
                                                (r = this.attemptGroupRelocation(t, e, c, s, d)).length > 0)
                                                return r
                                        }
                                        for (var h = 0; h < a; h += 1) {
                                            var u = i[h], p = n[h];
                                            ...
                                            (u && !p
                                                ...
                                                ? (r.push((new y)
                                                    ...
                                                    .setValue(this.options._const.value, u.data)), l -= 1)
                                                : (r.push((new y)
                                                    .setValue(this.options._const.action,
                                                        this.options._const.removeElement)
                                                    .setValue(this.options._const.route, s.concat(l))
                                                    .setValue(this.options._const.element, m(u))), l -= 1)
                                                : p &&
                                                !u &&
                                                ("#text" === p.nodeName
                                                    ? r.push((new y)
                                                    ...
                                                    : r.push((new y)
                                                        ...
                                                        .setValue(this.options._const.route, s.concat(l))
                                                        .setValue(this.options._const.element, m(p))))), u && p)
                                                if (!this.options.maxChildCount || a < this.options.maxChildCount)
                                                    ...
                                                    if (i.length > n.length)
                                                        "#text" === u.nodeName
                                                            ...
                                                            : r.push((new y)
                                                                .setValue(this.options._const.action,
                                                                    this.options._const.removeElement)
                                                                .setValue(this.options._const.element, m(u))
                                                                .setValue(this.options._const.route, s.concat(l))), i
                                                            .splice(h,
                                                                1), h -= 1, l -= 1, o -= 1;
                                        ...
                                        for (var a,
                                            ...
                                            if (!n || !0 !== u[_] && !0 !== p[_])
                                                if (!0 === u[_])
                                                            ...
                                                            if (l.data !== e.childNodes[_].data) {
                                                                ...
                                                                if (!d)
                                                                    return g.push((new y)
                                                                        .setValue(this.options._const.action,
                                                                            this.options._const.modifyTextElement)
                                                                        .setValue(this.options._const.route,
                                                                            i.concat(_))
                                                                        .setValue(this.options._const.oldValue, l.data)
                                                                        .setValue(this.options._const.newValue,
                                                                            e.childNodes[_].data)), g
                                                            }
                                                        } else
                                                            g.push((new y)
                                                                    .setValue(this.options._const.action,
                                                                    ...
                                                                    .setValue(this.options._const.value, l.data)), u
                                                                    .splice(_, 1),
                                                                f = Math.min(u.length, p.length), _ -= 1;
                                                    else
                                                        g.push((new y)
                                                            .setValue(this.options._const.action,
                                                                this.options._const.removeElement)
                                                            .setValue(this.options._const.route, i.concat(_))
                                                            .setValue(this.options._const.element, m(l))), u.splice(_,
                                                            1), f =
                                                            Math.min(u.length, p.length), _ -= 1;
                                                else if (!0 === p[_])
                                                    "#text" === (l = e.childNodes[_]).nodeName
                                                        ? (g.push((new y)
                                                                .setValue(this.options._const.action,
                                                                    this.options._const.addTextElement)
                                                                .setValue(this.options._const.route, i.concat(_))
                                                                .setValue(this.options._const.value, l.data)), u.splice(
                                                                _,
                                                                0,
                                                                !0),
                                                            f = Math.min(u.length, p.length), w -= 1)
                                                        : (g.push((new y)
                                                                .setValue(this.options._const.action,
                                                                    this.options._const.addElement)
                                                                .setValue(this.options._const.route, i.concat(_))
                                                                .setValue(this.options._const.element, m(l))), u.splice(
                                                                _,
                                                                0,
                                                                !0),
                                                            f = Math.min(u.length, p.length), w -= 1);
                                                    ...
                                                    if (r = s[u[_]], (o =
                                                            Math.min(r.newValue, t.childNodes.length - r.length)) !==
                                                        r.oldValue) {
                                                        a = !1;
                                        ...
                                        return t.selected !== e.selected &&
                                            i.push((new y)
                                                ...
                                                .setValue(this.options._const.route, s)), (t.value || e.value) &&
                                            t.value !== e.value &&
                                            "OPTION" !== t.nodeName &&
                                            i.push((new y).setValue(this.options._const.action,
                                                ...
                                                .setValue(this.options._const.route, s)), t.checked !== e.checked &&
                                            i.push((new y)
                                                ...
                                                .setValue(this.options._const.route, s)), i
                                    }, t
                                }(),
                                k = {
                                    debug: !1,
                                    ...
                                    maxChildCount: 50,
                                    valueDiffing: !0,
                                    textDiff: function(t, e, s, i) { t.data = i },
                                ...
                                T = function() {
                                    function t(t) {
                                        if (void 0 === t && (t = {}), Object.entries(k).forEach((function(e) {
                                            ...
                                            var e = [
                                                    ...
                                                    "modifyTextElement",
                                                    "relocateGroup", "removeElement", "addElement", "removeTextElement",
                                                    "addTextElement", "replaceElement", "modifyValue", "modifyChecked",
                                                    "modifySelected", "modifyComment", "action", "route", "oldValue",
                                                    "newValue", "element", "group", "groupLength", "from", "to", "name",
                                                    "value", "data", "attributes", "nodeName", "childNodes", "checked",
                                                    "selected"
                                                ],
                                                s = {};
                                            t.compress
                                                ? e.forEach((function(t, e) { return s[t] = e }))
                                                : e.forEach((function(t) { return s[t] = t })), t._const = s
                                        }
                                        this.options = t
                                    }

                                    return t.prototype.apply =
                                        function(t, e) {
                                            return function(t, e, s) {
                                                return e.every((function(e) { return d(t, e, s) }))
                                            }(t,
                                                e,
                                                this.options)
                                    ...
                                    }, t.prototype.diff = function(t, e) { return new S(t, e, this.options).init() }, t
                                }();
                            const A = (t, e, s, { classes:i, format:n, hiddenHeader:a, sortable:o, scrollY:r, type:l },
                                      { noColumnWidths:d, unhideHeader:c }) => ({
                                          ...
                                          childNodes: t.map(((t, h) => {
                                              ...
                                              if (u.sortable &&
                                                  ...
                                                  u.headerClass && (p.class = u.headerClass), s.sort &&
                                                      s.sort.column === h) {
                                                  const t = "asc" === s.sort.dir ? i.ascending : i.descending;
                                                  p.class = p.class ? `${p.class} ${t}` : t, p["aria-sort"] =
                                                  ...
                                                  (p.class = p.class
                                                      ...
                                                      : i.filterActive);
                                              let f = "";
                                              s.widths[h] && !d && (f += `width: ${s.widths[h]}%;`), r.length &&
                                                  !c &&
                                                  (f += "padding-bottom: 0;padding-top: 0;border: 0;"), f.length &&
                                                  (p.style = f), u.headerClass && (p.class = u.headerClass);
                                              const m = "html" === t.type
                                                  ? t.data
                                ...
                                P = (t, e, s, i, n, a,
                                {
                                                ...
                                                childNodes: s.map((({ row:t, index:e }) => {
                                                    const s = {
                                                        ...
                                                        childNodes: t.map(((t, s) => {
                                                            const a = i[s] ||
                                                                { type: p, format: c, sortable: !0, searchable: !0 };
                                                            if (a.hidden) return;
                                                            const o = "html" === a.type
                                                    ...
                                                    if (e === a && (s.attributes.class = o.cursor), f) {
                                                        ...
                                                        if (i) {
                                                            if ("string" != typeof i) return i;
                                                            {
                                                                ...
                                                                !t.childNodes ||
                                                                    1 === t.childNodes.length &&
                                                                    ["#text", "#comment"].includes(t.childNodes[0]
                                                                        .nodeName)
                                    ...
                                    if (_.attributes.class =
                                        _.attributes.class ? `${_.attributes.class} ${o.table}` : o.table,
                                    l || d || v) {
                                        const t = A(e,
                                            i,
                                            n,
                                        ...
                                        if (l || v) {
                                            ...
                                            !u.length && !r || b || (e.attributes = { style: "height: 0px;" }), _
                                                .childNodes
                                                .unshift(e)
                                        }
                                        if (d) {
                            ...
                            var H = {}, R = { get exports() { return H }, set exports(t) { H = t } };
                            R.exports = function() {
                                var t = 1e3,
                                    e = 6e4,
                                    s = 36e5,
                                    ...
                                    v = {
                                        ...
                                        p: function(t) {
                                            return{ M: d, y: h, w: l, d: r, D: u, h: o, m: a, s: n, ms: i, Q: c }[t] ||
                                    ...
                                    w = {};
                                w[_] = g;
                                var y = function(t) { return t instanceof M },
                                    x = function t(e, s, i) {
                                        var n;
                                        if (!e) return _;
                                        if ("string" == typeof e) {
                                ...
                                var M = function() {
                                        function g(t) { this.$L = x(t.locale, null, !0), this.parse(t) }
                                        ...
                                        return b.parse = function(t) {
                                                ...
                                                var t = this.$d;
                                                this.$y = t.getFullYear(), this.$M = t.getMonth(), this.$D =
                                                    t.getDate(), this.$W = t.getDay(), this.$H = t.getHours(), this.$m =
                                                    t.getMinutes(), this.$s = t.getSeconds(), this.$ms =
                                                    t.getMilliseconds()
                                            }, b.$utils = function() { return D }, b.isValid =
                                                function() { return!(this.$d.toString() === p) }, b.isSame =
                                                function(t, e) {
                                                    var s = N(t);
                                                    return this.startOf(e) <= s && s <= this.endOf(e)
                                                }, b.isAfter =
                                                function(t, e) { return N(t) < this.startOf(e) }, b.isBefore =
                                                function(t, e) { return this.endOf(e) < N(t) }, b.$g =
                                                function(t, e, s) { return D.u(t) ? this[e] : this.set(s, t) }, b.unix =
                                                function() { return Math.floor(this.valueOf() / 1e3) }, b.valueOf =
                                                function() { return this.$d.getTime() }, b.startOf = function(t, e) {
                                                var s = this,
                                                    i = !!D.u(e) || e,
                                                    c = D.p(t),
                                                    p = function(t, e) {
                                                        var n = D.w(s.$u ? Date.UTC(s.$y, e, t) : new Date(s.$y, e, t),
                                                            s);
                                                        return i ? n : n.endOf(r)
                                                    },
                                                    f = function(t, e) {
                                                        return D.w(s.toDate()[t].apply(s.toDate("s"),
                                            ...
                                            }, b.endOf = function(t) { return this.startOf(t, !1) }, b.$set =
                                                function(t, e) {
                                                    var s,
                                                        l = D.p(t),
                                                        c = "set" + (this.$u ? "UTC" : ""),
                                                        p = (s = {}, s[r] = c + "Date", s[u] = c + "Date", s[d] =
                                                            c + "Month", s[h] = c + "FullYear", s[o] =
                                                            c + "Hours", s[a] =
                                                            c + "Minutes", s[n] = c + "Seconds", s[i] =
                                                            c + "Milliseconds", s)[l],
                                                        f = l === r ? this.$D + (e - this.$W) : e;
                                                    if (l === d || l === h) {
                                                        var m = this.clone().set(u, 1);
                                                        m.$d[p](f), m.init(), this.$d =
                                                            m.set(u, Math.min(this.$D, m.daysInMonth())).$d
                                                    } else p && this.$d[p](f);
                                                    return this.init(), this
                                                }, b.set = function(t, e) { return this.clone().$set(t, e) }, b.get =
                                                function(t) { return this[D.p(t)]() }, b.add = function(i, c) {
                                                var u, p = this;
                                                i = Number(i);
                                                var f = D.p(c),
                                                    m = function(t) {
                                                ...
                                                return D.w(b, this)
                                            }, b.subtract = function(t, e) { return this.add(-1 * t, e) }, b.format =
                                                function(t) {
                                                    ...
                                                    var i = t || "YYYY-MM-DDTHH:mm:ssZ",
                                                        ...
                                                        h = function(t) { return D.s(a % 12 || 12, t, "0") },
                                                        u = s.meridiem ||
                                                            function(t, e, s) {
                                                                var i = t < 12 ? "AM" : "PM";
                                                    ...
                                                    return i.replace(m,
                                                        (function(t, e) { return e || f[t] || n.replace(":", "") }))
                                                }, b.utcOffset =
                                                function() {
                                            ...
                                            b.diff = function(i, u, p) {
                                                var f,
                                                    ...
                                                    v = this - g,
                                                    _ = D.m(this, g);
                                                return _ = (f = {}, f[h] = _ / 12, f[d] = _, f[c] = _ / 3, f[l] =
                                                        (v - b) / 6048e5, f[r] = (v - b) / 864e5, f[o] = v / s, f[a] =
                                                        v / e, f[n] =
                                                        v / t, f)[m] ||
                                                    v, p ? _ : D.a(_)
                                            }, b.daysInMonth = function() { return this.endOf(d).$D }, b.$locale =
                                                function() { return w[this.$L] }, b.locale = function(t, e) {
                                                if (!t) return this.$L;
                                                var s = this.clone(), i = x(t, e, !0);
                                                return i && (s.$L = i), s
                                            }, b.clone = function() { return D.w(this.$d, this) }, b.toDate =
                                                function() { return new Date(this.valueOf()) }, b.toJSON =
                                                function() { return this.isValid() ? this.toISOString() : null },
                                            b.toISOString = function() { return this.$d.toISOString() }, b.toString =
                                                function() { return this.$d.toUTCString() }, g
                                    }(),
                                    E = M.prototype;
                                return N.prototype =
                                        E, [
                                        ["$ms", i], ["$s", n], ["$m", a], ["$H", o], ["$W", r], ["$M", d], ["$y", h],
                                        ["$D", u]
                                    ].forEach((function(t) {
                                        E[t[1]] = function(e) { return this.$g(e, t[0], t[1]) }
                                    })),
                                    N.extend = function(t, e) { return t.$i || (t(e, M, N), t.$i = !0), N }, N.locale =
                                        x, N.isDayjs = y, N.unix = function(t) { return N(1e3 * t) }, N.en =
                                        w[_], N.Ls =
                                        w, N.p = {}, N
                            }();
                            var I = H, Y = {}, j = { get exports() { return Y }, set exports(t) { Y = t } };
                            j.exports = function() {
                                var t = {
                                        LTS: "h:mm:ss A",
                                        LT: "h:mm A",
                                    ...
                                    n = /\d*[^-_:/,()\s\d]+/,
                                    a = {},
                                    o = function(t) { return(t = +t) + (t > 68 ? 1900 : 2e3) },
                                    r = function(t) { return function(e) { this[t] = +e } },
                                    l = [
                                    ...
                                    h = {
                                        A: [n, function(t) { this.afternoon = c(t, !1) }],
                                        a: [n, function(t) { this.afternoon = c(t, !0) }],
                                        S: [/\d/, function(t) { this.milliseconds = 100 * +t }],
                                        SS: [s, function(t) { this.milliseconds = 10 * +t }],
                                        ...
                                        MMM: [
                                            n, function(t) {
                                                var e = d("months"),
                                                    s = (d("monthsShort") ||
                                                            e.map((function(t) { return t.slice(0, 3) })))
                                                        .indexOf(t) +
                                                        1;
                                ...
                                function u(s) {
                                    var i, n;
                                    i = s, n = a && a.formats;
                                    for (var o = (s = i.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g,
                                                 (function(e, s, i) {
                                                     var a = i && i.toUpperCase();
                                                     return s ||
                                                         n[i] ||
                                                         t[i] ||
                                                         n[a].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g,
                                                             (function(t, e, s) { return e || s.slice(1) }))
                                                 }))).match(e),
                                        r = o.length,
                                        l = 0;
                                        l < r;
                                    ...
                                    return function(t) {
                                        ...
                                        return function(t) {
                                            ...
                                            if (void 0 !== e) {
                                                var s = t.hours;
                                                e ? s < 12 && (t.hours += 12) : 12 === s && (t.hours = 0), delete t
                                                    .afternoon
                                            }
                                        }(e), e
                                    }
                                ...
                                return function(t, e, s) {
                                    ...
                                    i.parse = function(t) {
                                        ...
                                        if ("string" == typeof r) {
                                            ...
                                            d && (h = o[2]), a = this.$locale(), !l && h && (a = s.Ls[h]), this.$d =
                                                    function(t, e, s) {
                                                        try {
                                                            if (["x", "X"].indexOf(e) > -1)
                                                    ...
                                                    !0 !== h &&
                                                    (this.$L = this.locale(h).$L),
                                                c && e != this.format(r) && (this.$d = new Date("")), a = {}
                            ...
                            const B = (t, e) => {
                                ...
                                F = (t, e) => {
                                    if (t?.constructor === Object &&
                                        ...
                                        !Object.keys(t).find((t => !["text", "order", "data"].includes(t)))) return t;
                                    const s = { data: t };
                                    switch (e.type) {
                                    case"string":
                                    ...
                                    case"boolean":
                                        "string" == typeof s.data && (s.data = s.data.toLowerCase().trim()), s.data =
                                            !["false", !1, null, void 0, 0].includes(s.data), s.order =
                                            s.data ? 1 : 0, s.text =
                                            String(s.data);
                                        break;
                                    case"other":
                                ...
                                z = t => {
                                    if (t instanceof Object &&
                                        ...
                                        ("string" == typeof t.text || "string" == typeof t.data)) return t;
                                    const e = { data: t };
                                    if ("string" == typeof t) {
                                        if (t.length) {
                                            const s = L(`<th>${t}</th>`);
                                ...
                                U = (t, e, s, n, a) => {
                                    ...
                                    t.headings
                                        ...
                                        ? o.headings = Array.from(e.tHead.querySelectorAll("th")).map(((t, e) => {
                                            ...
                                            const r = s[e];
                                            return"false" !== t.dataset.sortable?.trim().toLowerCase() &&
                                                ...
                                                "true" !== t.dataset.hidden?.trim().toLowerCase() &&
                                                    ...
                                                    (r.hidden = !0), [
                                                        "number", "string", "html", "date", "boolean", "other"
                                                    ]
                                                    .includes(t.dataset.type) &&
                                                    (r.type = t.dataset.type, "date" === r.type &&
                                                        t.dataset.format &&
                                                        (r.format = t.dataset.format)), o
                                        }))
                                        : t.data?.length
                                        ? o.headings = t.data[0].map((t => z("")))
                                        : e?.tBodies.length &&
                                        (o.headings = Array.from(e.tBodies[0].rows[0].cells).map((t => z(""))));
                                    for (let t = 0; t < o.headings.length; t++)
                                        s[t] || (s[t] = { type: n, format: a, sortable: !0, searchable: !0 });
                                    if (t.data
                                        ? o.data = t.data.map((t => t.map(((t, e) => F(t, s[e])))))
                                        : e?.tBodies?.length &&
                                        (o.data = Array.from(e.tBodies[0].rows).map((t => Array.from(t.cells)
                                            .map(((t, e) => {
                                                const i = t.dataset.content
                                                    ...
                                                    : ((t, e) => {
                                                        ...
                                                        case"boolean":
                                                        {
                                                            const e = !["false", "0", "null", "undefined"].includes(t
                                                                .innerText
                                                                .toLowerCase().trim());
                                                ...
                                                return t.dataset.order &&
                                                (i.order = isNaN(parseFloat(t.dataset.order))
                                                    ? t.dataset.order
                                                    : parseFloat(t.dataset.order)), i
                            ...
                            class J {
                                constructor(t) { this.dt = t, this.cursor = !1 }
                                ...
                                add(t) {
                                    ...
                                    this.dt.data.data.push(e), this.dt.data.data.length && (this.dt.hasRows = !0), this
                                        .dt
                                        .update(!0)
                                }
                                ...
                                remove(t) {
                                    ...
                                    this.dt.data.data =
                                        this.dt.data.data.filter(((e, s) => !t.includes(s))),
                                    this.dt.data.data.length ||
                                        (this.dt.hasRows = !1), this.dt.update(!0)
                                }

                                findRowIndex(t, e) {
                                    return this.dt.data.data.findIndex((s => (s[t].text ?? String(s[t].data))
                                        .toLowerCase()
                            ...
                            class W {
                                constructor(t) { this.dt = t, this.init() }
                                    ...
                                    [this.settings, this._state] = ((t=[], e, s) => {
                                        ...
                                        return t.forEach((t => {
                                                (Array.isArray(t.select) ? t.select : [t.select]).forEach((o => {
                                                    i[o] ||
                                                        (i[o] = { type: t.type || e, sortable: !0, searchable: !0 });
                                                    const r = i[o];
                                                    t.render && (r.render = t.render),
                                                        ...
                                                        !1 === t.sortable
                                                            ? r.sortable = !1
                                                            : (t.numeric && (r.numeric = t.numeric), t.caseFirst &&
                                                        ...
                                                        t.hidden && (r.hidden = !0), t.filter && (r.filter = t.filter),
                                                        t.sortSequence && (r.sortSequence = t.sortSequence), t.sort &&
                                                            (t.filter ? a[o] = t.sort : n = { column: o, dir: t.sort })
                                                }))
                                            })), i = i.map((t => t ||
                                            {
                                                type: e,
                                ...
                                order(t) {
                                    this.dt.data.headings = t.map((t => this.dt.data.headings[t])), this.dt.data.data =
                                        this.dt.data.data.map((e => t.map((t => e[t])))), this.settings =
                                        t.map((t => this.settings[t])), this.dt.update()
                                }
                                ...
                                add(t) {
                                    ...
                                    if (this.dt.data.headings =
                                        this.dt.data.headings.concat([z(t.heading)]), this.dt.data.data =
                                        this.dt.data.data.map(((e, s) => e.concat([F(t.data[s], t)]))), this.settings[
                                            e] =
                                        { type: t.type || "string", sortable: !0, searchable: !0 }, t.type ||
                                        t.format ||
                                        t.sortable ||
                                        t.render ||
                                        t.filter) {
                                        const s = this.settings[e];
                                        t.render && (s.render = t.render), t.format && (s.format = t.format),
                                            t.cellClass && (s.cellClass = t.cellClass),
                                            t.headerClass && (s.headerClass = t.headerClass),
                                            t.locale && (s.locale = t.locale),
                                            !1 === t.sortable
                                                ? s.sortable = !1
                                                : (t.numeric && (s.numeric = t.numeric), t.caseFirst &&
                                                    (s.caseFirst = t.caseFirst)),
                                            !1 === t.searchable
                                                ? s.searchable = !1
                                            ...
                                            t.hidden && (s.hidden = !0),
                                            t.filter && (s.filter = t.filter), t.sortSequence &&
                                                (s.sortSequence = t.sortSequence)
                                    }
                                    this.dt.update(!0)
                                }
                                ...
                                remove(t) {
                                    ...
                                    this.dt.data.headings =
                                        this.dt.data.headings.filter(((e, s) => !t.includes(s))), this.dt.data.data =
                                        this.dt.data.data.map((e => e.filter(((e, s) => !t.includes(s))))), this.dt
                                        .update(
                                            !0)
                                }
                                ...
                                filter(t, e=!1) {
                                    ...
                                    i ? this._state.filters[t] = i : s && (this._state.filters[t] = void 0),
                                        this.dt._currentPage =
                                            1, this.dt.update(), e || this.dt.emit("datatable.filter", t, i)
                                }
                                ...
                                sort(t, e, s=!1) {
                                    ...
                                    const n = !!["string", "html"].includes(i.type) &&
                                        new Intl.Collator(i.locale || this.dt.options.locale,
                                            {
                                                ...
                                                ignorePunctuation: i.ignorePunctuation ||
                                    ...
                                    })), this._state.sort = { column: t, dir: e }, this.dt._searchQueries.length
                                        ? (this.dt.multiSearch(this.dt._searchQueries),
                                            this.dt.emit("datatable.sort", t, e))
                                        : s ||
                                        (this.dt._currentPage =
                                            1, this.dt.update(), this.dt.emit("datatable.sort", t, e))
                                }
                                    ...
                                    if ((this.dt.options.scrollY.length || this.dt.options.fixedColumns) && t?.length) {
                                        ...
                                        if (this.dt.options.header || this.dt.options.footer) {
                                            this.dt.options.scrollY.length && (t.unhideHeader = !0),
                                                this.dt.headerDOM &&
                                                    this.dt.headerDOM.parentElement.removeChild(this.dt.headerDOM), t
                                                    .noColumnWidths = !0, this.dt._renderTable(t);
                                            const e = Array.from(this.dt.dom
                                                .querySelector("thead, tfoot")?.firstElementChild?.querySelectorAll(
                                                    "th") ||
                                                []);
                                            let s = 0;
                            ...
                            const Q = {
                                      ...
                                      {
                                          placeholder: "Arama",
                                          searchTitle: "Tablo İçinde Arama",
                                          perPage: "/ Sayfa",
                                          noRows: "Veri Yok",
                                          noResults: "Eşleşen Veri Yok",
                                          info: ""
                                      },
                                ...
                                X = (t, e, s, i, n) => {
                                    ...
                                    let o = [...Array(i).keys()].map((t => Z(t + 1,
                                        String(t + 1),
                                        n,
                                        { active: t === s - 1 })));
                                    if (n.truncatePager &&
                            ...
                            class K {
                                constructor(t, e={}) { this.dt = t, this.options = { ...G, ...e } }

                                init() {
                                    this.initialized ||
                                    (this.dt.wrapperDOM.classList.add(this.options.classes.editable), this.options
                                        .inline &&
                                        (this.originalRowRender = this.dt.options.rowRender, this.dt.options.rowRender =
                                            (t, e, s) => {
                                                let i = this.rowRender(t, e, s);
                                                return this.originalRowRender &&
                                                    (i = this.originalRowRender(t, i, s)), i
                                            }), this.options.contextMenu &&
                                    (this.containerDOM =
                                        s("div", { id: this.options.classes.container }), this.wrapperDOM =
                                        s("div", { class: this.options.classes.wrapper }), this.menuDOM =
                                        s("ul", { class: this.options.classes.menu }), this.options.menuItems &&
                                        ...
                                        this.options.menuItems.forEach((t => {
                                            ...
                                            if (!t.separator) {
                                                ...
                                                e.appendChild(i), t.action &&
                                                    "function" == typeof t.action &&
                                                    i.addEventListener("click",
                                                        (e => { e.preventDefault(), t.action(this, e) }))
                                            }
                                            this.menuDOM.appendChild(e)
                                        })), this.wrapperDOM.appendChild(this.menuDOM), this.containerDOM.appendChild(
                                        this.wrapperDOM), this.update()), this.data = {}, this.closed =
                                        !0, this.editing =
                                        !1, this.editingRow = !1, this.editingCell =
                                        !1, this.bindEvents(), setTimeout((() => {
                                ...
                                bindEvents() {
                                    this.events =
                                        ...
                                        document.addEventListener("keydown", this.events.keydown), this.options
                                            .contextMenu &&
                                            (this.dt.dom.addEventListener("contextmenu", this.events.context), this
                                                .events.reset =
                                                function(t, e=300) {
                                                    let s;
                                                    return(...i) => {
                                                ...
                                                }((() => this.events.update()), 50), window.addEventListener("resize",
                                                this.events.reset), window.addEventListener("scroll",
                                                this.events.reset))
                                }
                                ...
                                context(t) {
                                    ...
                                    if (this.options.contextMenu && !this.disabled && s) {
                                        ...
                                        e > this.limits.x && (e -= this.rect.width),
                                            s > this.limits.y && (s -= this.rect.height), this.wrapperDOM.style.top =
                                                `${s}px`, this.wrapperDOM.style.left =
                                                `${e}px`, this.openMenu(), this.update()
                                    }
                                }
                                ...
                                editCell(t) {
                                    ...
                                    this.data =
                                            { cell: i, rowIndex: s, columnIndex: e, content: i.text || String(i.data) },
                                        this.editing = !0, this.editingCell =
                                            !0, this.options.inline ? this.dt.update() : this.editCellModal(), this
                                            .closeMenu()
                                }
                                ...
                                editCellModal() {
                                    const t = this.data.cell,
                                        ...
                                        a = [
                                            ...
                                            `<button class='${this.options.classes.close
                                            }' type='button' data-editor-close>${this.options.labels.closeX}</button>`,
                                            " </div>", `<div class='${this.options.classes.block}'>`,
                                            `<form class='${this.options.classes.form}'>`,
                                            `<div class='${this.options.classes.row}'>`,
                                            `<label class='${this.options.classes.label}'>${n(i)}</label>`,
                                            `<input class='${this.options.classes.input}' value='${n(t.text ||
                                                String(t.data) ||
                                                "")}' type='text'>`, "</div>",
                                            `<div class='${this.options.classes.row}'>`,
                                            `<button class='${this.options.classes.save
                                            }' type='button' data-editor-save>${
                                            this.options.labels.save}</button>`, "</div>", "</form>", "</div>", "</div>"
                                        ].join(""),
                                    ...
                                    r.focus(), r.selectionStart = r.selectionEnd = r.value.length, o.addEventListener(
                                        "click",
                                        (t => {
                                            const e = t.target;
                                            if (e instanceof Element)
                                ...
                                saveCell(t) {
                                    const e = this.data.content,
                                        s = this.dt.columns.settings[this.data.columnIndex].type ||
                                    ...
                                    if ("number" === s) n = { data: parseFloat(i) };
                                        ...
                                        const e = this.dt.columns.settings[this.data.columnIndex].format ||
                                    ...
                                    this.data = {}, this.dt.update(!0), this.editing = !1, this.editingCell =
                                        !1, this.dt.emit("editable.save.cell", t, e, a, o)
                                }

                                editRow(t) {
                                    if (!t || "TR" !== t.nodeName || this.editing) return;
                                    const e = parseInt(t.dataset.index, 10), s = this.dt.data.data[e];
                                    this.data = { row: s, rowIndex: e }, this.editing = !0, this.editingRow =
                                        !0, this.options.inline ? this.dt.update() : this.editRowModal(),
                                    this.closeMenu()
                                }
                                ...
                                editRowModal() {
                                    ...
                                    t.forEach(((t, e) => {
                                        ...
                                        if ((!i.hidden || i.hidden && this.options.hiddenColumns) &&
                                            !this.options.excludeColumns.includes(e)) {
                                            const i = this.dt.data.headings[e].text ||
                                            ...
                                            o.insertBefore(s("div",
                                                    {
                                                        ...
                                                        html: [
                                                            `<div class='${this.options.classes.row}'>`,
                                                            `<label class='${this.options.classes.label}'>${n(i)
                                                            }</label>`,
                                                            `<input class='${this.options.classes.input}' value='${n(
                                                                t.text || String(t.data) || "")}' type='text'>`,
                                                            "</div>"
                                                        ].join("")
                                                    }),
                                                o.lastElementChild)
                                    ...
                                    const r = Array.from(
                                        o.querySelectorAll(`input.${this.options.classes.input}[type=text]`));
                                    r.pop(), i.addEventListener("click",
                                        (t => {
                                            const e = t.target;
                                            ...
                                            (e.hasAttribute("data-editor-close")
                                                ...
                                                : e.hasAttribute("data-editor-save") &&
                                                this.saveRow(r.map((t => t.value.trim())), this.data.row))
                                        }))
                                }
                                ...
                                saveRow(t, e) {
                                    ...
                                    this.dt.data.data[this.data.rowIndex] = this.dt.data.data[this.data.rowIndex].map(
                                        ((e, s) => {
                                            if (this.dt.columns.settings[s].hidden ||
                                                this.options.excludeColumns.includes(s)) return e;
                                            ...
                                            if ("number" === i) r = { data: parseFloat(a) };
                                                ...
                                                r = { data: [{ nodeName: "#text", data: n }], text: n, order: n };
                                        ...
                                        {}, this.dt.update(!0), this.closeModal(), this.dt.emit("editable.save.row",
                                        t,
                                        s,
                                        e)
                                }

                                openModal() { this.modalDOM && document.body.appendChild(this.modalDOM) }

                                closeModal() {
                                    this.editing &&
                                        this.modalDOM &&
                                        (document.body.removeChild(this.modalDOM), this.modalDOM = this.editing =
                                            this.editingRow = this.editingCell = !1)
                                }
                                ...
                                dismiss(t) {
                                    ...
                                    this.options.contextMenu &&
                                        this.editing &&
                                        (s = !e.matches(`input.${this.options.classes.input}[type=text]`)), s &&
                                        this.closeMenu()
                                }
                                ...
                                openMenu() {
                                    ...
                                    this.options.contextMenu &&
                                    (document.body.appendChild(this.containerDOM), this.closed =
                                        !1, this.dt.emit("editable.context.open"))
                                }
                                ...
                                closeMenu() {
                                    this.options.contextMenu &&
                                        !this.closed &&
                                        (this.closed =
                                            !0, document.body.removeChild(this.containerDOM), this.dt.emit(
                                ...
                                destroy() {
                                    this.dt.dom.removeEventListener(this.options.clickEvent, this.events.click),
                                        ...
                                        document.body.contains(this.containerDOM) &&
                                            document.body.removeChild(this.containerDOM), this.options.inline &&
                                            (this.dt.options.rowRender = this.originalRowRender), this.initialized = !1
                                }
                            ...
                            exports.DataTable = class{
                                constructor(t, e={}) {
                                    ...
                                    this.options = { ...Q, ...e, labels: i, classes: n }, this._initialInnerHTML =
                                            this.options.destroyable ? this.dom.innerHTML : "", this.options.tabIndex
                                            ? this.dom.tabIndex = this.options.tabIndex
                                            : this.options.rowNavigation &&
                                            -1 === this.dom.tabIndex &&
                                            (this.dom.tabIndex = 0),
                                        this._listeners = { onResize: () => this._onResize() }, this._dd =
                                            new T({ valueDiffing: !1 }), this.initialized = !1, this._events =
                                            {}, this._currentPage = 0, this.onFirstPage = !0, this.hasHeadings =
                                            !1, this.hasRows = !1, this._searchQueries = [], this.init()
                                }

                                init() {
                                    if (this.initialized || this.dom.classList.contains(this.options.classes.table))
                                        return!1;
                                    this._virtualDOM = D(this.dom, { valueDiffing: !1 }), this._tableAttributes =
                                        { ...this._virtualDOM.attributes }, this.rows = new J(this), this.columns =
                                        new W(this), this.data =
                                        U(this.options.data,
                                            this.dom,
                                            this.columns.settings,
                                            this.options.type,
                                            this.options.format), this._render(), setTimeout((() => {
                                ...
                                _render() {
                                    this.wrapperDOM =
                                            s("div",
                                                {
                                                    class: `${this.options.classes.wrapper} ${this.options.classes
                                                        .loading}`
                                                }),
                                    ...
                                    t && this.options.paging && this.options.perPageSelect
                                            ...
                                            : t && t.parentElement.removeChild(t), this.containerDOM =
                                            this.wrapperDOM.querySelector(`.${this.options.classes.container}`),
                                        this._pagerDOMs =
                                            [],
                                        Array.from(this.wrapperDOM.querySelectorAll(
                                                `.${this.options.classes.pagination}`))
                                            .forEach((t => {
                                                t instanceof HTMLElement &&
                                                (t.innerHTML =
                                                    `<ul class="${this.options.classes.paginationList}"></ul>`, this
                                                    ._pagerDOMs
                                                    .push(t.firstElementChild))
                                        ...
                                        this._label =
                                            this.wrapperDOM.querySelector(`.${this.options.classes.info}`),
                                        this.dom.parentElement.replaceChild(this.wrapperDOM, this.dom),
                                        this.containerDOM.appendChild(this.dom), this._rect =
                                            this.dom.getBoundingClientRect(), this._fixHeight(),
                                        ...
                                        this._bindEvents(), this.columns._state.sort &&
                                            this.columns.sort(this.columns._state.sort.column,
                                                this.columns._state.sort.dir,
                                                !0), this.update(!0)
                                }

                                _renderTable(t={}) {
                                    let e = P(this._tableAttributes,
                                        this.data.headings,
                                ...
                                _renderPage(t=!1) {
                                    this.hasRows && this.totalPages
                                        ? (this._currentPage > this.totalPages && (this._currentPage = 1),
                                            this._renderTable(), this.onFirstPage =
                                                1 === this._currentPage, this.onLastPage =
                                                this._currentPage === this.lastPage)
                                        : this.setMessage(this.options.labels.noRows);
                                    let e, s = 0, i = 0, n = 0;
                                    if (this.totalPages &&
                                    (s = this._currentPage - 1, i = s * this.options.perPage, n =
                                        i + this.pages[s].length, i += 1, e = this._searchQueries.length
                                        ? this._searchData.length
                                        : this.data.data.length), this._label && this.options.labels.info.length) {
                                        const t = this.options.labels.info.replace("{start}", String(i))
                                            .replace("{end}", String(n)).replace("{page}", String(this._currentPage))
                                            .replace("{pages}", String(this.totalPages)).replace("{rows}", String(e));
                                        this._label.innerHTML = e ? t : ""
                                    }
                                    if (1 == this._currentPage && this._fixHeight(), this.options.rowNavigation &&
                                        this._currentPage &&
                                        (!this.rows.cursor ||
                                ...
                                _renderPagers() {
                                    ...
                                    this._pagerDOMs.forEach((t => { this._dd.apply(t, e) })), this._virtualPagerDOM = t
                                }

                                _renderSeparateHeader() {
                                    const t = this.dom.parentElement;
                                    this.headerDOM ||
                                    (this.headerDOM = document.createElement("div"), this._virtualHeaderDOM =
                                        { nodeName: "DIV" }), t.parentElement.insertBefore(this.headerDOM, t);
                                    let e = {
                                        nodeName: "TABLE",
                                ...
                                _bindEvents() {
                                            ...
                                            t.addEventListener("change",
                                                (() => {
                                                    this.options.perPage =
                                                        parseInt(t.value, 10), this.update(), this._fixHeight(), this
                                                        .emit(
                                                            "datatable.perpage",
                                                            this.options.perPage)
                                                }),
                                    ...
                                    this.options.searchable &&
                                        this.wrapperDOM.addEventListener("keyup",
                                            (t => {
                                                const e = t.target;
                                                if (!(e instanceof HTMLInputElement &&
                                                    e.matches(`.${this.options.classes.input}`))) return;
                                                t.preventDefault();
                                                const s = Array
                                                    .from(
                                                        this.wrapperDOM.querySelectorAll(
                                                            `.${this.options.classes.input}`))
                                                    .filter((t => t.value.length)).map((t => t.dataset.columns
                                            ...
                                            })), this.wrapperDOM.addEventListener("click",
                                        (t => {
                                            ...
                                            if (e)
                                                if (e.hasAttribute("data-page"))
                                                    ...
                                                    const s = Array.from(e.parentElement.parentElement.children)
                                        ...
                                        ? (this.dom.addEventListener("keydown",
                                            (t => {
                                                if ("ArrowUp" === t.key) {
                                                    ...
                                                    t.preventDefault(), t.stopPropagation(),
                                                        this.pages[this._currentPage - 1].find(
                                                            (t => t.index === this.rows.cursor || (e = t, !1))), e
                                            ...
                                            (t => {
                                                ...
                                                if (e instanceof Element && this.dom.matches(":focus")) {
                                                    const s = Array.from(this.dom.querySelectorAll("body tr"))
                                                        .find((t => t.contains(e)));
                                                    s &&
                                                        s instanceof HTMLElement &&
                                                        this.emit("datatable.selectrow",
                                ...
                                _onResize() {
                                    this._rect =
                                        this.containerDOM.getBoundingClientRect(), this._rect.width && this.update(!0)
                                }

                                destroy() {
                                    this.options.destroyable &&
                                    (this.dom.innerHTML =
                                            this._initialInnerHTML, this.dom.classList.remove(
                                        ...
                                        this.initialized =
                                            !1, window.removeEventListener("resize", this._listeners.onResize))
                                }

                                update(t=!1) {
                                    t &&
                                        (this.columns._measureWidths(), this.hasRows =
                                            Boolean(this.data.data.length), this.hasHeadings =
                                            Boolean(this.data.headings.length)),
                                        this.wrapperDOM.classList.remove(this.options.classes.empty), this._paginate(),
                                        this._renderPage(), this._renderPagers(), this.options.scrollY.length &&
                                            this._renderSeparateHeader(), this.emit("datatable.update")
                                }

                                _paginate() {
                                    let t = this.data.data.map(((t, e) => ({ row: t, index: e })));
                                    return this._searchQueries.length &&
                                        (t = [], this._searchData.forEach(
                                            (e => t.push({ index: e, row: this.data.data[e] })))),
                                        this.columns._state.filters.length &&
                                            this.columns._state.filters.forEach(((e, s) => {
                                                e &&
                                                (t = t.filter((t => "function" == typeof e
                                                    ? e(t.row[s].data)
                                                    : (t.row[s].text ?? t.row[s].data) === e)))
                                            })), this.options.paging && this.options.perPage > 0
                                            ? this.pages =
                                            t.map(((e, s) => s % this.options.perPage == 0
                                                ? t.slice(s, s + this.options.perPage)
                                                : null)).filter((t => t))
                                            : this.pages = [t], this.totalPages = this.lastPage =
                                            this.pages.length, this._currentPage || (this._currentPage = 1), this
                                            .totalPages
                                }

                                _fixHeight() {
                                    this.options.fixedHeight &&
                                    (this.containerDOM.style.height = null, this._rect =
                                        this.containerDOM.getBoundingClientRect(), this.containerDOM.style.height =
                                        `${this._rect.height}px`)
                                }

                                search(t, e) {
                                    if (!t.length)
                                        return this._currentPage = 1, this._searchQueries = [], this._searchData =
                                            [], this.update(), this.emit("datatable.search", "", []), this.wrapperDOM
                                            .classList.remove("search-results"), !1;
                                    this.multiSearch([{ term: t, columns: e || void 0 }]), this.emit("datatable.search",
                                        t,
                                        this._searchData)
                                }
                                ...
                                multiSearch(t) {
                                    ...
                                    if (this._currentPage = 1, this._searchQueries = t, this._searchData =
                                        [], !(t = t.filter((t => t.term.length))).length)
                                        return this.update(), this.emit("datatable.multisearch",
                                            t,
                                            this._searchData), this
                                            .wrapperDOM.classList.remove("search-results"), !1;
                                    const e = t.map((t => this.columns.settings.map(((e, s) => {
                                        ...
                                        return(e.ignorePunctuation || this.options.ignorePunctuation) &&
                                            (i = i.replace(/[.,/#!$%^&*;:{}=-_`~()]/g, "")), i
                                    }))));
                                    this.data.data.forEach(((t, s) => {
                                        ...
                                        e.every(
                                                (t => t.find(
                                                    ((t, e) => !!t && t.split(" ").find((t => i[e].includes(t))))))) &&
                                            this._searchData.push(s)
                                    })), this.wrapperDOM.classList.add("search-results"), this._searchData.length
                                        ? this.update()
                                        : (this.wrapperDOM.classList.remove("search-results"), this.setMessage(this
                                            .options
                                            .labels.noResults)), this.emit("datatable.multisearch", t, this._searchData)
                                }

                                page(t, e=!1) {
                                    return t !== this._currentPage &&
                                    (isNaN(t) || (this._currentPage = t), !(t > this.pages.length || t < 0) &&
                                    (this._renderPage(e), this._renderPagers(), void this.emit("datatable.page",
                                        t)))
                                }
                                ...
                                insert(e) {
                                    ...
                                    if (Array.isArray(e)) {
                                        ...
                                        e.forEach(((e, i) => {
                                            ...
                                            Object.entries(e).forEach((([e, s]) => {
                                                ...
                                                a > -1
                                                    ...
                                                    0 !== i ||
                                                    (n[t.length] =
                                                        F(s, this.columns.settings[t.length]), t.push(e), this.data
                                                        .headings
                                                        .push(z(e)))
                                            })), s.push(n)
                                        }))
                                        ...
                                        (!e.headings || this.hasHeadings || this.hasRows
                                            ...
                                            (s = e.data.map((t => t.map(((t, e) => F(t, this.columns.settings[e]))))))
                                            : this.data = U(e,
                                                void 0,
                                                this.columns.settings,
                                                this.options.type,
                                                this.options.format));
                                    s.length && s.forEach((t => this.data.data.push(t))), this.hasHeadings =
                                        Boolean(this.data.headings.length), this.columns._state.sort &&
                                        this.columns.sort(this.columns._state.sort.column,
                                            this.columns._state.sort.dir,
                                            !0), this.update(!0)
                                }
                                ...
                                refresh() {
                                    ...
                                    (Array.from(this.wrapperDOM.querySelectorAll(`.${this.options.classes.input}`))
                                        .forEach((t => { t.value = "" })), this._searchQueries = []),
                                    this._currentPage =
                                        1, this.onFirstPage = !0, this.update(!0), this.emit("datatable.refresh")
                                }
                                ...
                                setMessage(t) {
                                    const e = this.data.headings.filter(((t, e) => !this.columns.settings[e]?.hidden))
                                        .length ||
                                        1;
                                    this.wrapperDOM.classList.add(this.options.classes.empty), this._label &&
                                        (this._label.innerHTML = ""), this.totalPages = 0, this._renderPagers();
                                    let s = {
                                        nodeName: "TABLE",
                                        attributes: { class: this.options.classes.table },
                                        childNodes: [
                                ...
                                on(t, e) { this._events[t] = this._events[t] || [], this._events[t].push(e) }
                                ...
                                if (i.data.length) {
                                    ...
                                    (i.headings &&
                                        (s.headings = t[0].split(i.columnDelimiter), i.removeDoubleQuotes &&
                                            (s.headings = s.headings.map((t => t.trim().replace(/(^"|"$)/g, "")))), t
                                            .shift()),
                                        t.forEach(((t, e) => {
                                            s.data[e] = [];
                                            ...
                                            n.length &&
                                                n.forEach((t => {
                                                    i.removeDoubleQuotes && (t = t.trim().replace(/(^"|"$)/g, "")), s
                                                        .data[e]
                                                        .push(t)
                                                }))
                                        }))), s) return s
                                ...
                                if (a[0] = o, i.selection)
                                    if (Array.isArray(i.selection))
                                        for (let t = 0; t < i.selection.length; t++)
                                            a = a.concat(e.pages[i.selection[t] - 1].map(
                                                (t => t.row.filter(((t, e) => n(e))).map((t => t.text ?? t.data)))));
                                    else
                                        a = a.concat(e.pages[i.selection - 1].map((t => t.row.filter(((t, e) => n(e)))
                                            .map((t => t.text ?? t.data)))));
                                else
                                    a = a.concat(
                                        e.data.data.map((t => t.filter(((t, e) => n(e)))
                                            .map((t => t.text ?? t.data)))));
                                if (a.length) {
                                    let t = "";
                                    if (a.forEach((e => {
                                        e.forEach((e => {
                                            "string" == typeof e &&
                                                ...
                                                (e = `"${e}"`), t += e + i.columnDelimiter
                                        })), t = t.trim().substring(0, t.length - 1), t += i.lineDelimiter
                                    })), t = t.trim().substring(0, t.length - 1), i.download) {
                                        const e = document.createElement("a");
                                        e.href = encodeURI(`data:text/csv;charset=utf-8,${t}`), e.download =
                                                `${i.filename || "datatable_export"}.csv`, document.body.appendChild(e),
                                ...
                                if (i.selection)
                                    if (Array.isArray(i.selection))
                                        for (let t = 0; t < i.selection.length; t++)
                                            a = a.concat(e.pages[i.selection[t] - 1].map(
                                                (t => t.row.filter(((t, e) => n(e))).map((t => t.data)))));
                                    else
                                        a = a.concat(
                                            e.pages[i.selection - 1].map((t => t.row.filter(((t, e) => n(e)))
                                                .map((t => t.data)))));
                                else
                                ...
                                if (a.length) {
                                    const t = [];
                                    a.forEach(((e, s) => {
                                        t[s] = t[s] || {}, e.forEach(((e, i) => { t[s][o[i]] = e }))
                                    }));
                                    ...
                                    if (i.download) {
                                        ...
                                        n.href = s, n.download =
                                                `${i.filename || "datatable_export"}.json`,
                                            document.body.appendChild(n),
                                            n.click(), document.body.removeChild(n), URL.revokeObjectURL(s)
                                    }
                                    return e
                                }
                                return!1
                                ...
                                if (a.length) {
                                    ...
                                    if (o.forEach((e => { t += `\`${e}\`,` })), t =
                                        t.trim().substring(0, t.length - 1), t += ") VALUES ", a.forEach((e => {
                                        t += "(", e.forEach((e => {
                                            t += "string" == typeof e ? `"${e}",` : `${e},`
                                        })), t =
                                            t.trim().substring(0, t.length - 1), t += "),"
                                    })), t = t.trim().substring(0, t.length - 1), t += ";", i.download &&
                                        (t = `data:application/sql;charset=utf-8,${t}`), i.download) {
                                        const e = document.createElement("a");
                                        e.href = encodeURI(t), e.download =
                                                `${i.filename || "datatable_export"}.sql`, document.body.appendChild(e),
                                            e.click(), document.body.removeChild(e)
                                    }
                                    return t
                                }
                                ...
                                if (a.length) {
                                    ...
                                    if (a.forEach((e => {
                                        ...
                                        (t = `data:text/csv;charset=utf-8,${t}`), i.download) {
                                        const e = document.createElement("a");
                                        e.href = encodeURI(t), e.download =
                                                `${i.filename || "datatable_export"}.txt`, document.body.appendChild(e),
                                            e.click(), document.body.removeChild(e)
                                    }
                                    return t
                                }
